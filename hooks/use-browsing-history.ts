...
import { persist } from 'zustand/middleware' // Persist browsing history in local storage
type BrowsingHistory = {
  products: { id: string; category: string }[]   // Array of products with id and category
}
const initialState: BrowsingHistory = {
  products: [],
}

export const browsingHistoryStore = create<BrowsingHistory>()( // Create store for browsing history
